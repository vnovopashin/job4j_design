...
/**
 * Класс демонстрирует механизм сериализации/десериализации
 * Сериализация - процесс преобразования объекта в бинарный
 * (т.е. в последовательность битов) или текстовый формат.
 * Десериализация - процесс преобразования сериализованных данных в объекты,
 * т.е. операция обратная сериализации.
 *
